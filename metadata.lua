...
--- Plugin homepage
PLUGIN.homepage = "https://github.com/yanecc/vfox-clang"
--- Plugin license, please choose a correct license according to your needs.
PLUGIN.license = "Apache 2.0"
--- Plugin description
PLUGIN.description = "Clang plugin, https://clang.llvm.org/"
...
NOTE:
    ...
    --]]
PLUGIN.manifestUrl = "https://github.com/yanecc/vfox-clang/releases/download/manifest/manifest.json"
